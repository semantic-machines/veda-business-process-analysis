...
export default class ProcessEdit extends Component(HTMLElement) {
  ...
  render() {
    return html`
      <div class="sheet">
        <h3 class="mb-0" about="v-bpa:BusinessProcess" property="rdfs:label"></h3>
        <div class="mb-3">
          <label class="form-label" about="rdfs:label" property="rdfs:label"></label>
          <input type="text" class="form-control" is="${InputText}" about="${this.model.id}" data-property="rdfs:label">
        </div>
        <div class="row">
          <div class="col-12 col-md-9">
            <div class="mb-3">
              <label class="form-label" about="v-bpa:processDescription" property="rdfs:label"></label>
              <textarea class="form-control" is="${Textarea}" about="${this.model.id}" data-property="v-bpa:processDescription" rows="3"></textarea>
            </div>

            <div class="mb-3">
              <label class="form-label" about="v-bpa:responsibleDepartment" property="rdfs:label"></label>
              <input type="text" class="form-control" is="${InputText}" about="${this.model.id}" data-property="v-bpa:responsibleDepartment">
            </div>

            <div class="mb-3">
              <label class="form-label" about="v-bpa:processFrequency" property="rdfs:label"></label>
            ...
            <div class="mb-3">
              <label class="form-label" about="v-bpa:laborCosts" property="rdfs:label"></label>
              <div class="input-group">
          ...
          <div class="col-12 col-md-3 border-start border-secondary-subtle">
            <div class="mb-3">
              <label class="form-label" about="v-bpa:processParticipant" property="rdfs:label"></label>
