...
import DocumentFiltersForm from './DocumentFiltersForm.js';

export default class DocumentFiltersModal extends Component(HTMLElement) {
  static tag = 'bpa-document-filters-modal';
...
customElements.define(DocumentFiltersModal.tag, DocumentFiltersModal);